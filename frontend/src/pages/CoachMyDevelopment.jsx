...
import { 
  ...
  Loader2, Eye, Edit2, Check, X, Archive, Plus, ChevronDown, ChevronUp, FileText, Bell, Trash2, Lock
} from 'lucide-react';
...
export default function CoachMyDevelopment() {
  ...
  }, [sessions, searchQuery, sessionFilters, dataRetention]);
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        ...
        {/* Reflection Prompt - Smaller, closable design */}
        {has_pending_reflection && pending_reflection_session_id && !reflectionPromptDismissed && (
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <p className="text-sm text-blue-800 truncate">
                  You have a session awaiting reflection
                </p>
              </div>
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <Button
                  ...
                  onClick={() => setReflectionPromptDismissed(true)}
                  data-testid="dismiss-reflection-prompt-btn"
                >
                  <X className="w-4 h-4" />
                </Button>
              </div>
